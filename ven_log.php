            ...
            <div class=" collapse navbar-collapse" id="collapsibleNavbar">
                ...
                <div class="links">
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./ven_log.php">Registration</a>
                        </li>
                </div>
            </div>
        </div>
    ...
    <section class="container reg ">
        ...
        <div class="row shadow p-4 content">
            ...
            <div class="col-6 col-md-6">
                ...
                <!-- form -->
                <form action="ven_log.php" method="post">
                    ...
                    <div class="form-group form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1"><a href="./ven_reg.php">Not yet registered? Click here to register</a></label>
                    </div>
