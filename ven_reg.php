...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password == $cpassword) {
        ...
        $sql = "INSERT INTO `vendor` ( `userid`, `email`,`name`, `password`,`address`,`phn`) VALUES ('$userid','$email','$name','$hash','$address','$phn')";
    ...
    <section class="container reg ">
        <div class="row shadow p-4 content">
            ...
            <div class="col-6 col-md-6">
                ...
                <!-- form -->
                <form class="form" action="./ven_reg.php" method="post">
                    ...
                    <br />
                    <a class="liink" href="ven_log.php">Already Registered!! Click here to login</a>
                </form>
